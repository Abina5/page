    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          SizedBox(height: 20),
          Center(
              child: Text('Slash Flutter provides extraordinary flutter ',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20,
